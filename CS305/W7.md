...
released a research paper on how Youtube researchers use deep neural networks to decide which videos to reccommend [3].
There are even courses created by Youtube and support pages detailing exactly how their system works [16, Youtube2].
...
the conputer. Youtube and content creators get a majority of their revenue from advertisers, but this
comes at a cost of restricting content to be advertiser friendly. There have been a number of incidences
...
The Google Ad Program shows clear preference for certain content creators over others, and it certainly seems to
...
MILLION dislikes as opposed to 2.5 likes [YouTube Spotlight]. This video featured prominent youtubers like
Will Smith (?!?!?!).

I think that it is quite clear where the preference lies for Google and Youtube. As with most other companies
and organizations in a world currently dominated by corporations and controlled by the politics of 
businessmen, money takes the prize. To combat this, I think that Youtube needs to do a better job at listening to
the people who actually use their site.
...
prominent content creators, not just present general blanket states about how their are looking to resolve the
issue.
...
reccomends, rather than only content that can generate the most ad revenue. Perhaps also offering areas of improvement
for users by specifying exactly for which reasons a video was identified as not being advertiser friendly.
